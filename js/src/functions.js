/* ----------------------------------------------  /
/  Relax Player 0.69 September -2009
		...
		onComplete: function(jsonObj) {
			...
			if (jsonObj.file) {
 			  jsonObj.file.each(function(track) {
				...
				tbl +="<tr id='0' class='even'><td colspan='0' onmouseover='current_row=false' align='center'>"+language.error_nofiles+"</td></tr>";
			}
...
function refreshPlaylist(jsonObj) {
    ...
    if (plStatus.playlistlength==0) {
        newBody = new Element('div').setHTML("<table><tbody><tr id='pl0' class='even' onmouseover='current_row=false'><td colspan='0' align='center'>"+language.error_notracks+"</td></tr></tbody></table>");
